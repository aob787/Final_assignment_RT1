...
if("TRUE" STREQUAL "TRUE")
  set(gmapping_SOURCE_PREFIX /home/tachadol/Y1-S1/RT/RT1_assignment3/rt1_as3_ws/src/slam_gmapping/gmapping)
  set(gmapping_DEVEL_PREFIX /home/tachadol/Y1-S1/RT/RT1_assignment3/rt1_as3_ws/devel)
  set(gmapping_INSTALL_PREFIX "")
  set(gmapping_PREFIX ${gmapping_DEVEL_PREFIX})
else()
  set(gmapping_SOURCE_PREFIX "")
  set(gmapping_DEVEL_PREFIX "")
  set(gmapping_INSTALL_PREFIX /home/tachadol/Y1-S1/RT/RT1_assignment3/rt1_as3_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tachadol/Y1-S1/RT/RT1_assignment3/rt1_as3_ws/src/slam_gmapping/gmapping/${idir}'.  ${_report}")
    endif()
